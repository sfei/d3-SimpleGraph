...
/* harmony default export */ var sg_draw_points = (function (SimpleGraph, d3) {
  ...
  SimpleGraph.prototype.drawPoints = function (showNulls) {
    ...
    for (var series in pointsDataBySeries) {
      this._drawPoints(this.svgGraph.selectAll(".sg-temporary-point").data(data).enter(), this.ptSeriesShapes[series]);
    }
...
/* harmony default export */ var sg_draw_lines = (function (SimpleGraph, d3) {
  ...
  SimpleGraph.prototype._drawLines = function (lines, className, transition) {
    ...
    lines = lines.filter(function (line) {
      return line._segments && line._segments.length >= 2;
    });
    var self = this,
        addedLines = this.svgGraph.selectAll(".sg-temporary-line").data(lines).enter().append("path").attr("series", line.series).attr("class", className).attr("opacity", transition ? 0 : 1).style("fill", 'none').attr("d", function (d) {
      var yAxis = d.y2 ? self.y2 : self.y,
