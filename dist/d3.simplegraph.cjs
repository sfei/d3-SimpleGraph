...
function SimpleGraph(params) {
  ...
  // create the SVG
  this.svg = external_d3_namespaceObject.select(params.container).append("svg").attr("width", this.containerWidth).attr("height", this.containerHeight).style('font-family', "'Century Gothic', CenturyGothic, Geneva, AppleGothic, sans-serif").style('overflow', 'visible');
...
sg_axis(SimpleGraph, external_d3_namespaceObject_0);
// Color/category functions

sg_color(SimpleGraph, external_d3_namespaceObject_0);
// Grid and legend

sg_grid_legend(SimpleGraph, external_d3_namespaceObject_0);
// Data functions



sg_data_point(SimpleGraph, external_d3_namespaceObject_0);
sg_data_area(SimpleGraph, external_d3_namespaceObject_0);
sg_data_line(SimpleGraph, external_d3_namespaceObject_0);
// Draw functions




sg_draw_lib(SimpleGraph, external_d3_namespaceObject_0);
sg_draw_points(SimpleGraph, external_d3_namespaceObject_0);
sg_draw_lines(SimpleGraph, external_d3_namespaceObject_0);
sg_draw_areas(SimpleGraph, external_d3_namespaceObject_0);
// Interactivity functions


sg_tooltip(SimpleGraph, external_d3_namespaceObject_0);
sg_highlight(SimpleGraph, external_d3_namespaceObject_0);
...
exports.SimpleGraph = __webpack_exports__["default"];
/******/ })()
;